...
interface LoginViewProps {
  ...
  onEmailOnlySignIn?: (email: string) => Promise<void>;
  defaultEmail?: string;
  mode?: 'page' | 'dialog';
  onCancel?: () => void;
}
...
const LoginView: React.FC<LoginViewProps> = ({
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const targetEmail = (defaultEmail || email).trim();
      if (onEmailOnlySignIn) {
        await onEmailOnlySignIn(targetEmail);
      } else {
